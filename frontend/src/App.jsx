      ...
      <nav className="bg-blue-800 text-white p-4 shadow-md">
        <div className="container mx-auto flex justify-between font-semibold">
          <div className="flex gap-4">
            ...
            <Link to="/dicos" className="hover:text-blue-300 border-l border-blue-600 pl-4">DICO DM 37/08</Link>
        ...
        <Routes>
          <Route path="/" element={
            <div className="container mx-auto">
              ...
              <p>Benvenuto. Usa il menu in alto per gestire l'anagrafica, i materiali, e compilare le Dichiarazioni (DICO e DIRI).</p>
            </div>
          } />
